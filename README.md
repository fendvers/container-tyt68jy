...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-tyt68jy.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-tyt68jy.containers.anotherwebservice.com/
...
```
git clone git@github.com:fendvers/container-tyt68jy.git
cd container-tyt68jy
```
...
```
docker attach container-tyt68jy
```
